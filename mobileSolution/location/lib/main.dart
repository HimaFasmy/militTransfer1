...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("MilitTransfer"),
      ),
      body: Center(
        child: Column(
          ...
          children: [
            ElevatedButton(
              onPressed: () {
                _determinePosition(); //fun1
                listenToLocationChanges();//fun2
              },
              child:
              Text("Determine position")),
  ...
  void listenToLocationChanges() {
    final LocationSettings locationSettings = LocationSettings(
      ...
      distanceFilter: 1,/* should be crossed with the database set values*/
    );
